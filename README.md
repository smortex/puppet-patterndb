...
* Only handles paterndb at the time: Will probably be merged to other syslog-ng modules
* Doesn't handle correlation using contexts. Will be implemented soon(ish)
